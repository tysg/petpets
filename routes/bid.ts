...
router.patch("/:ct_email/:owner_email/:pet_name/:start_date", bidsController.update);
router.delete("/:ct_email/:owner_email/:pet_name/:start_date", bidsController.remove);
