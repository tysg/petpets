...
const UserSiteLayout = (props: PropsWithChildren<RouteChildrenProps>) => {
  const logout = () => {
    clearToken();
    props.history.push("/");
  };
        ...
        <Sider width={200} className="site-layout-background">
          ...
          >
            <SubMenu key="sub1" icon={<UserOutlined />} title="Pet Owner">
              ...
              <Menu.Item key="4">My Past Orders</Menu.Item>
            </SubMenu>
            <SubMenu key="sub2" icon={<LaptopOutlined />} title="Pet Sitter">
              <Menu.Item key="5">My Availability</Menu.Item>
              <Menu.Item key="6">My Past Jobs</Menu.Item>
            </SubMenu>
          </Menu>
        </Sider>
